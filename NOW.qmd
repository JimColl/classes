...
2)  This system^[ [[20240429055542]] Zettlekasten] is a rebellion against my unruly digital footprint^[ [[20230829120127]] My digital footprint] as I atttempt to coherently tackle my [wicked problem](wicked_problems.qmd) with water.
...
4)  I want to 'gamify' water forecasting.  To accomplish that, I need to be smarter and have better systems.
       ...
       * Should help facilitate a multi-model depth enabled ensemble likelihood flood mapping capabilities usable for the entire country^[credit to Derek via Tom for the mission].
5)  How the founding values and constitution cross the digital divide.
